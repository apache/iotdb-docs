...
* For REST API access, the `INSERT INTO QUERY` statement can be executed via the [/rest/table/v1/nonQuery](../API/RestAPI-V1_apache.md#_3-3-non-query-interface) endpoint.
