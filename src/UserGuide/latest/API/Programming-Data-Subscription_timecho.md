...
IoTDB provides powerful data subscription functionality, allowing users to access newly added data from IoTDB in real-time through subscription APIs. For detailed functional definitions and introductions：[Data subscription](../User-Manual/Data-subscription_timecho)
...
This section is used to illustrate the core development process and does not demonstrate all parameters and interfaces. For a comprehensive understanding of all features and parameters, please refer to: [Java Native API](../API/Programming-Java-Native-API_timecho#_3-native-interface-description)
...
public class DataConsumerExample {
    ...
    public static void main(String[] args) throws IoTDBConnectionException, StatementExecutionException {
        try (SubscriptionSession session = new SubscriptionSession("127.0.0.1", 6667, "root", "TimechoDB@2021", 67108864)) { //Before V2.0.6.x the default password is root
            // 1. open session
            session.open();
...
public class DataConsumerExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        consumerConfig.put(ConsumerConstant.PASSWORD_KEY, "TimechoDB@2021"); //Before V2.0.6.x the default password is root
...
| password                | optional: TimechoDB@2021 //Before V2.0.6.x the default password is root              | `String`: The password of the DataNode in IoTDB              |
