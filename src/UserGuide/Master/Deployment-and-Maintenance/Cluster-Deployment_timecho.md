...
| **Configuration**               | **Description**                                              | **Default**     | **Recommended value**                                        | 192.168.1.3   | 192.168.1.4   | 192.168.1.5   | Note                                     |
| ------------------------------- | ------------------------------------------------------------ | --------------- | ------------------------------------------------------------ | ------------- | ------------- | ------------- | ---------------------------------------- |
| dn_rpc_address                  | The address of the client RPC service                                        | 127.0.0.1       |  The IPV4 address or hostname or 0.0.0.0 of the server where it is located, it is recommended to use **hostname**     When set to**0.0.0.0**, the redirection function is not available       When set to**PV4 address or hostname**, please set the enableAutoFetch value in the session to false       |  iotdb-1       |iotdb-2       | iotdb-3       | Restarting the service takes effect       |
