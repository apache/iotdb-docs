...
| **Configuration**               | **Description**                                              | **Default**     | **Recommended value**                                        | 192.168.1.3   | 192.168.1.4   | 192.168.1.5   | Note                                     |
| ------------------------------- | ------------------------------------------------------------ | --------------- | ------------------------------------------------------------ | ------------- | ------------- | ------------- | ---------------------------------------- |
| dn_rpc_address                  | The address of the client RPC service                                        | 127.0.0.1       |  The IPV4 address or hostname or 0.0.0.0 of the server where it is located, it is recommended to use **hostname**<br>When set to **0.0.0.0**, the redirection function is not available. Please set the enableAutoFetch value in the session to false<br>When set to **IPV4 address or hostname** , the command line terminal (CLI) connection requires specifying an IP address       |  iotdb-1       |iotdb-2       | iotdb-3       | Restarting the service takes effect       |
