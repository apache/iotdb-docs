...
For more details, see document [Operate-Metadata](../Basic-Concept/Operate-Metadata_timecho.md).
...
For more details, see document [Write-Data](../Basic-Concept/Write-Data_timecho).
...
For more details, see document [Data Import](../Tools-System/Data-Import-Tool_timecho).
...
For more details, see document [Write-Delete-Data](../Basic-Concept/Write-Data_timecho).
...
For more details, see document [Query-Data](../Basic-Concept/Query-Data_timecho).
...
### 13.2 Configuring time range for resampling
...
### 13.3 Configuring execution intervals and CQ time ranges
...
### 13.4 Configuring end_time_offset for CQ time range
...
### 13.5 CQ without group by clause
...
For more details, see document [Authority Management](../User-Manual/Authority-Management_timecho.md).
