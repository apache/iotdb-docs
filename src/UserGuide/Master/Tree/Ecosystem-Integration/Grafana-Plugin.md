...
### 1.2 Acquisition method of grafana plugin
...
### 1.5 Configure IoTDB REST Service
...
## 2. How to use Grafana-Plugin

### 2.1 Access Grafana dashboard
...
### 2.4 Support for variables and template functions
