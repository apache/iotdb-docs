...
对于 **FLOAT** 与 **DOUBLE** 类型的序列，如果编码方式采用 [RLE](../Basic-Concept/Encoding-and-Compression.md) 或 [TS_2DIFF](../Basic-Concept/Encoding-and-Compression.md) ，可以在创建序列时通过 `MAX_POINT_NUMBER` 属性指定浮点数的小数点后位数。
