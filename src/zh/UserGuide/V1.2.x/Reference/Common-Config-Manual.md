...
|:---:|:--------------------------------------------------------------------------------------------------------|
|描述| 合并结束后对顺序文件时间范围的检查, NONE 关闭检查，RESOURCE_ONLY 检查 resource 文件，RESOURCE_AND_TSFILE 检查 resource 文件和 tsfile 文件 |
|类型| String                                                                                                  |
|默认值| NONE                                                                                                    |
|改后生效方式| 热加载                                                                                                     |
...
|     名字     | config\_node_ratis_grpc_leader_outstanding_appends_max |
| :----------: | :----------------------------------------------------- |
...
|     名字     | config\_node_ratis_log_force_sync_num |
| :----------: | :------------------------------------ |
