...
在构建IoTDB建模方案前，需要先了解时序数据和时序数据模型，详细内容见此页面：[基础概念](../Background-knowledge/Common-Concepts_apache.md)
...
* [GO 原生接口](../API/Programming-Go-Native-API.md)
...
* [C# 原生接口](../API/Programming-CSharp-Native-API.md)
