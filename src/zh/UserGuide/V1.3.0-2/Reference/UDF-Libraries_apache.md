...
1. 请获取与 IoTDB 版本兼容的 UDF 函数库 JAR 包的压缩包。
    ...
    | --------------- | ----------------- | ------------------------------------------------------------ |
    | UDF-1.3.3.zip | V1.3.3及以上      | [压缩包](https://alioss.timecho.com/upload/apache-UDF-1.3.3.zip)   |
    | UDF-1.3.2.zip | V1.0.0～V1.3.2  | [压缩包](https://alioss.timecho.com/upload/apache-UDF-1.3.2.zip) |
