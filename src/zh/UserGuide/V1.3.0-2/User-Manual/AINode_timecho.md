...
图中10/24 00:00之前的数据为输入模型的过去数据，10/24 00:00后的黄色线条为模型给出的油温预测结果，而蓝色为数据集中实际的油温数据（用于进行对比）。
...
图中 02/14 20:44 之前的数据为输入模型的过去数据， 02/14 20:44 后的黄色线条为模型给出的C相电压预测结果，而蓝色为数据集中实际的A相电压数据（用于进行对比）。
