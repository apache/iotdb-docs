...
详细说明及示例见文档 [比较运算符和函数](../SQL-Manual/Function-and-Expression.md#_3-比较运算符和函数)。
...
详细说明及示例见文档 [逻辑运算符](../SQL-Manual/Function-and-Expression.md#_4-逻辑运算符)。
...
详细说明及示例见文档 [聚合函数](../SQL-Manual/Function-and-Expression.md#_1-聚合函数)。
...
详细说明及示例见文档 [数学函数](../SQL-Manual/Function-and-Expression.md#_2-2-数学函数)。
...
详细说明及示例见文档 [字符串处理函数](../SQL-Manual/Function-and-Expression.md#_5-字符串处理)。
...
详细说明及示例见文档 [数据类型转换](../SQL-Manual/Function-and-Expression.md#_6-数据类型转换)。
...
详细说明及示例见文档 [常序列生成函数](../SQL-Manual/Function-and-Expression.md#_7-常序列生成函数)。
...
详细说明及示例见文档 [选择函数](../SQL-Manual/Function-and-Expression.md#_8-选择函数)。
...
详细说明及示例见文档 [区间查询函数](../SQL-Manual/Function-and-Expression.md#_9-区间查询函数)。
...
详细说明及示例见文档 [趋势计算函数](../SQL-Manual/Function-and-Expression.md#_10-趋势计算函数)。
...
详细说明及示例见文档 [采样函数](../SQL-Manual/Function-and-Expression.md#_11-采样函数)。
### 2.11 时间序列处理函数
...
详细说明及示例见文档 [时间序列处理](../SQL-Manual/Function-and-Expression.md#_12-时间序列处理)。
...
详细说明及示例见文档 [条件表达式](../SQL-Manual/Function-and-Expression.md#_13-条件表达式)
...
IoTDB 中支持的运算符列表见文档 [运算符和函数](../SQL-Manual/Function-and-Expression.md#_2-算数运算符和函数)。
...
IoTDB 支持的聚合函数见文档 [聚合函数](../SQL-Manual/Function-and-Expression.md#_1-聚合函数)。
