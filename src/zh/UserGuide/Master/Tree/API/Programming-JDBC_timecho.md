...
public class JDBCExample {
  ...
  public static Connection getConnection() {
    ...
    String password = "TimechoDB@2021"; // V2.0.6.x 之前默认密码是 root
...
```java
DriverManager.getConnection("jdbc:iotdb://127.0.0.1:6667?charset=GB18030", "root", "TimechoDB@2021")
// V2.0.6.x 之前默认密码是 root
```
...
public class JDBCCharsetExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (final Connection connection =
            DriverManager.getConnection(
                "jdbc:iotdb://127.0.0.1:6667?charset=GB18030", "root", "TimechoDB@2021"); // V2.0.6.x 之前默认密码是 root
  ...
  private static void outputResult(String charset) throws SQLException {
    ...
    try (final Connection connection =
            DriverManager.getConnection(
                "jdbc:iotdb://127.0.0.1:6667?charset=" + charset, "root", "TimechoDB@2021"); // V2.0.6.x 之前默认密码是 root
        final IoTDBStatement statement = (IoTDBStatement) connection.createStatement()) {
