...
* 查询语句
```sql
select s1, zero_count(s1) from root.sg.d2;
```
* 输出
```
+-----------------------------+-------------+-------------------------+
...
* 查询语句
```sql
select s1, non_zero_count(s2) from root.sg.d2;
```
* 输出
```
+-----------------------------+-------------+-----------------------------+
|                         Time|root.sg.d2.s1|non_zero_count(root.sg.d2.s2)|
+-----------------------------+-------------+-----------------------------+
|1970-01-01T08:00:00.000+08:00|            0|                         null|
|1970-01-01T08:00:00.001+08:00|            1|                            2|
|1970-01-01T08:00:00.002+08:00|            1|                         null|
|1970-01-01T08:00:00.003+08:00|            0|                         null|
|1970-01-01T08:00:00.004+08:00|            1|                            1|
|1970-01-01T08:00:00.005+08:00|            0|                         null|
|1970-01-01T08:00:00.006+08:00|            0|                         null|
|1970-01-01T08:00:00.007+08:00|            1|                            1|
+-----------------------------+-------------+-----------------------------+
```
